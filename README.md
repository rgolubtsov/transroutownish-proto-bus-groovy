...
The microservice might be built and run successfully under **Ubuntu Server (Ubuntu 24.04.1 LTS x86-64)**. Install the necessary dependencies (`openjdk-17-jdk-headless`, ~~`groovy`, `gradle`~~, `make`, `docker.io`):
